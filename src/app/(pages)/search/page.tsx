                ...
                <div className="mb-6 sm:mb-8 md:mb-10">
                    ...
                    {query && (
                        <p className="text-gray-400 text-xs sm:text-sm md:text-base lg:text-lg">
                            Results for: <span className="text-red-500 font-semibold">&ldquo;{query}&rdquo;</span>
                        </p>
                    )}
                </div>
                        ...
                        <div className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-lg p-3 sm:p-4 md:p-5 lg:p-6 space-y-3 sm:space-y-4 animate-fade-in">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                                <button
                                    ...
                                    className="flex-1 sm:flex-none px-4 sm:px-6 py-2 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-colors text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 focus:ring-offset-black"
                                >
                                    Apply Filters
                                </button>
                                <button
                                    ...
                                    className="flex-1 sm:flex-none px-4 sm:px-6 py-2 bg-gray-800 hover:bg-gray-700 text-white font-semibold rounded-lg transition-colors text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2 focus:ring-offset-black"
                                >
                                    Reset
                                </button>
                            </div>
